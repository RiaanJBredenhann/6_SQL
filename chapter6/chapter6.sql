...
SELECT lt.id, lt.right_school, en.enrollment, gr.grades
FROM schools_right AS lt LEFT JOIN schools_enrollment AS en
	ON lt.id = en.id
LEFT JOIN schools_grades AS gr
	ON lt.id = gr.id;
...
FROM 'C:\YourDirectory\chapter6\us_counties_2000.csv'
